...
void far pascal TEXT_nputs(unsigned int, unsigned int, void far *, unsigned int, unsigned int);
...
void far pascal TEXT_setfont(void far *);
...
void far pascal TEXT_nputs(unsigned int s_x, unsigned int s_y, void far *s_str, unsigned int s_length, unsigned int s_color)
{
           while(s_length--)TEXT_putc(s_x++, s_y, *(((unsigned char far *)s_str)++), s_color);
}
...
void far pascal TEXT_setfont(void far *s_font)
{
 unsigned int s_count, s_cc;
           outportb(0x03c5, inx(0x03c4, 0x04)|0x04); outportb(0x03cf, inx(0x03ce, 0x05)&0xef);
           outx(0x03c4, 0x02, 0x04); outx(0x03ce, 0x04, 0x02); outx(0x03ce, 0x06, 0x00);
           ...
           outx(0x03c4, 0x04, 0x03); outx(0x03ce, 0x05, 0x10); outx(0x03c4, 0x02, 0x03);
           outx(0x03ce, 0x04, 0x00); outx(0x03ce, 0x06, 0x0e);
}
